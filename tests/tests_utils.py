...
def test_find_isolated_tiles(sou: str, pin: str, man: str, honors: str, result: bool) -> None:
    ...
    assert (tile_34 in isolated_tiles) == result
...
def test_is_strictly_isolated_tile(sou: str, pin: str, man: str, honors: str, result: bool) -> None:
    hand_34 = TilesConverter.string_to_34_array(sou="1399", pin="1567", man="25", honors="1224")
    tile_34 = _string_to_34_tile(sou=sou, pin=pin, man=man, honors=honors)
    assert is_tile_strictly_isolated(hand_34, tile_34) == result
...
def test_is_dora_indicator_for_terminal(sou: str, pin: str, man: str, honors: str, result: bool) -> None:
    tile_34 = _string_to_34_tile(sou=sou, pin=pin, man=man, honors=honors)
    assert is_dora_indicator_for_terminal(tile_34) == result
