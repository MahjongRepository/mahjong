...
Wind yakuhai are now represented as individual yaku classes per direction: `YakuhaiSeatEast`, `YakuhaiSeatSouth`, `YakuhaiSeatWest`, `YakuhaiSeatNorth` for seat winds, and `YakuhaiRoundEast`, `YakuhaiRoundSouth`, `YakuhaiRoundWest`, `YakuhaiRoundNorth` for round winds.
...
- Wind yakuhai classes have been renamed and restructured:
  - `YakuhaiEast` → `YakuhaiSeatEast`, `YakuhaiSouth` → `YakuhaiSeatSouth`, `YakuhaiWest` → `YakuhaiSeatWest`, `YakuhaiNorth` → `YakuhaiSeatNorth`. Each now checks only the seat wind condition.
  - `YakuhaiOfPlace` and `YakuhaiOfRound` have been removed and replaced by per-direction round wind classes: `YakuhaiRoundEast`, `YakuhaiRoundSouth`, `YakuhaiRoundWest`, `YakuhaiRoundNorth`.
