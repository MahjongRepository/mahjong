...
class FuCalculationTestCase(unittest.TestCase, TestMixin):
    ...
    def test_open_hand_base(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(
            hand, win_tile, self._get_win_group(hand, win_tile), config, melds=melds
        )
    ...
    def test_open_hand_without_additional_fu_2(self):
        fu_calculator = FuCalculator()
    ...
    def test_valued_pair_fu(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(
            hand, win_tile, self._get_win_group(hand, win_tile), config, valued_tiles=valued_tiles
        )
        self.assertEqual(2, len(fu_details))
        self.assertTrue({"fu": 30, "reason": FuCalculator.BASE} in fu_details)
    ...
    def test_incorrect_fu_calculation_test_case_1(self):
        ...
        self.assertEqual(3, len(result.fu_details))
