...
class FuCalculationTestCase(unittest.TestCase, TestMixin):
    ...
    def test_chitoitsu_fu(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, self._get_win_group(hand, win_tile),  is_tsumo=True)
        self.assertEqual(1, len(fu_details))
        self.assertTrue({'fu': 25, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue(fu, 25)
    ...
    def test_open_hand_base(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, self._get_win_group(hand, win_tile),  melds=melds)
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.OPEN_PON} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_fu_based_on_win_group(self):
        ...
        # pinfu wait 4-5-6
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, win_groups[0])
        self.assertTrue(fu, 30)

        # pair wait 66
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, win_groups[1])
        self.assertTrue(fu, 30)
    ...
    def test_open_hand_without_additional_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.HAND_WITHOUT_FU} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_tsumo_hand_base(self):
        ...
        fu_details, _ = fu_calculator.calculate_fu(hand, win_tile, self._get_win_group(hand, win_tile),  is_tsumo=True)
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
    ...
    def test_tsumo_hand_and_not_pinfu(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, self._get_win_group(hand, win_tile),  is_tsumo=True)
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.TSUMO} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_penchan_fu(self):
        ...
        fu_details, fu = fu_calculator.calculate_fu(hand, win_tile, self._get_win_group(hand, win_tile))
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.PENCHAN} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_kanchan_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.KANCHAN} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_pair_wait_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 2, 'reason': HandFuCalculator.PAIR_WAIT} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_closed_pon_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 4, 'reason': HandFuCalculator.CLOSED_PON} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_closed_terminal_pon_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 8, 'reason': HandFuCalculator.CLOSED_TERMINAL_PON} in fu_details)
        self.assertTrue(fu, 30)
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 4, 'reason': HandFuCalculator.OPEN_TERMINAL_PON} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_closed_kan_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 16, 'reason': HandFuCalculator.CLOSED_KAN} in fu_details)
        self.assertTrue(fu, 50)
    ...
    def test_open_kan_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 8, 'reason': HandFuCalculator.OPEN_KAN} in fu_details)
        self.assertTrue(fu, 30)
    ...
    def test_closed_terminal_kan_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 30, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 32, 'reason': HandFuCalculator.CLOSED_TERMINAL_KAN} in fu_details)
        self.assertTrue(fu, 72)
    ...
    def test_open_terminal_kan_fu(self):
        ...
        self.assertEqual(2, len(fu_details))
        self.assertTrue({'fu': 20, 'reason': HandFuCalculator.BASE} in fu_details)
        self.assertTrue({'fu': 16, 'reason': HandFuCalculator.OPEN_TERMINAL_KAN} in fu_details)
        self.assertTrue(fu, 40)
