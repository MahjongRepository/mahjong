...
class HandDividerTestCase(unittest.TestCase, TestMixin):
    ...
    def test_simple_hand_dividing(self):
        ...
        self.assertEqual(self._string(result[0]), ["234m", "567m", "234s", "55s", "777z"])
    ...
    def test_second_simple_hand_dividing(self):
        ...
        result = hand.divide_hand(tiles_34)
        self.assertEqual(len(result), 1)
        self.assertEqual(self._string(result[0]), ["123m", "123p", "123s", "11z", "222z"])
    ...
    def test_hand_with_pairs_dividing(self):
        ...
        result = hand.divide_hand(tiles_34)
        self.assertEqual(len(result), 1)
        self.assertEqual(self._string(result[0]), ["234m", "44m", "345p", "456p", "333s"])
    ...
    def test_one_suit_hand_dividing(self):
        ...
        self.assertEqual(self._string(result[0]), ["111m", "222m", "333m", "888m", "99m"])
        self.assertEqual(self._string(result[1]), ["123m", "123m", "123m", "888m", "99m"])
    ...
    def test_second_one_suit_hand_dividing(self):
        ...
        result = hand.divide_hand(tiles_34)
        self.assertEqual(len(result), 1)
        self.assertEqual(self._string(result[0]), ["111s", "123s", "666s", "789s", "11z"])
    ...
    def test_third_one_suit_hand_dividing(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertEqual(self._string(result[0]), ["234p", "789p", "789p", "789p", "22z"])
    ...
    def test_chitoitsu_like_hand_dividing(self):
        ...
        result = hand.divide_hand(tiles_34)
        self.assertEqual(len(result), 2)
        self.assertEqual(self._string(result[0]), ["11m", "22m", "33m", "99p", "44s", "55s", "66s"])
        self.assertEqual(self._string(result[1]), ["123m", "123m", "99p", "456s", "456s"])
