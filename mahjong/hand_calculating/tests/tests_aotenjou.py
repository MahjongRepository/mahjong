...
class AotenjouCalculationTestCase(unittest.TestCase, TestMixin):
    def test_aotenjou_hands(self):
        ...
        result = hand.estimate_hand_value(
            ...
            config=self._make_hand_config(player_wind=EAST, round_wind=EAST, disable_double_yakuman=True),
        )
        ...
        result = hand.estimate_hand_value(
            ...
            melds=melds,
            scores_calculator_factory=Aotenjou,
            config=self._make_hand_config(is_tsumo=True, player_wind=EAST, round_wind=EAST),
        )
        self.assertEqual(result.error, None)
    ...
    def test_daisharin(self):
        ...
        result = hand.estimate_hand_value(
            ...
            win_tile,
            scores_calculator_factory=Aotenjou,
            config=self._make_hand_config(is_tsumo=True, player_wind=EAST, round_wind=EAST, allow_daisharin=True),
        )
        self.assertEqual(result.error, None)
