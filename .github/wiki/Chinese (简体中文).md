...
| 功能 关键 | 字参数 | 默认值 |
| -------- | ---- | ----- |
| 有无食断（非门前清断幺九是否成立） | has\_open\_tanyao | False
| 有无红宝牌 | has\_aka\_dora | False
| 有无双倍役满役种（如四暗刻单骑） | has\_double\_yakuman | True
| 非役满役种累计番数上限设置（累计役满//累计三倍满） | kazoe\_limit | HandConstants.KAZOE\_LIMITED
| 有无切上满贯 | kiriage | False
| 非门清平和型食和是否+2符（总计30符） | fu\_for\_open\_pinfu | True
| 平和自摸是否仍然+2符（总计30符） | fu\_for\_pinfu\_tsumo | False
| 人和是否视为役满（还是只有5番） | renhou\_as\_yakuman | False
| 是否有大车轮役种（门前清22334455667788饼） | has\_daisharin | False
| 是否有其他花色的大车轮役种（索：大竹林，万：大数邻） | has\_daisharin\_other\_suits | False
| 放铳开立直是否算役满 | has\_sashikomi\_yakuman | False
| 多倍役满是否上限为6倍 (最高得点192000) | limit\_to\_sextuple\_yakuman | True
| 是否有大七星役满役种（字牌七对子） | has\_daichisei | False
| 八连庄是否需要有役才能成立 | paarenchan\_needs\_yaku | True
